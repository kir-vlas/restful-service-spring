<template>
    <div v-if="!this.$parent.currentUser" class="login-box">
        ...
        <div class="md-input">
            <input class="md-text-field" required @keyup.enter="loginUser()" title="Password" v-model="user.password" type="password"/>
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Password</label>
        </div>
        <span v-if="errorLabel" class="error-label">Wrong username/password</span>
        <button class="create-button login-button" @click="loginUser()"><span class="login-button-text">Login</span></button>
    </div>
</template>
...
<style>
    ...
    .md-input .md-text-field:focus 	{ outline:none; }
